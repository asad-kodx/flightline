    ...
    children: [
      {
        ...
        loadChildren: () => import('./control-detail-tabs/control-detail-tabs.module')
      ...
      {
        path: 'entity-alarms',
        loadChildren: () => import('./entity-alarms/entity-alarms.module')
          .then(m => m.EntityAlarmsPageModule)
      },
      {
        path: 'entity-graphs',
        loadChildren: () => import('./entity-graphs/entity-graphs.module')
